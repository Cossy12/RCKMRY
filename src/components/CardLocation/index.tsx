...
const CardLocation: React.FC<CardLocationProps> = ({
  ...
  return (
    <div className="flex flex-col iphone:min-h-24 fh:h-full border-2 border-green-700 rounded-lg justify-center px-4 bg-gray-800  cursor-pointer shadow-lg hover:shadow-2xl hover:border-grey-500 my-1">
