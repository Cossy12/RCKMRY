...
const CardShimmers: React.FC<CardShimmersProps> = ({
  ...
  return (
    <div className="animate-pulse flex h-full border-2 border-green-700 rounded-lg items-center px-4 bg-gray-800 cursor-pointer shadow-lg my-1">
      {type === 'character' && (
        <img
          src="images/ricked.png"
          alt=""
